...
<head>
  <meta charset="utf-8">
    ...
    <title>Simple Admin - Log in </title>
				...
				<div class="row justify-content-center no-gutters">
					<div class="col-lg-4 col-md-5 col-12">
						<div class="content-top-agile p-10">
							<h2 class="text-white">Simple E-commerce Admin</h2>
                            ...
                            @csrf
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="text" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Email" type="email" name="email" :value="old('email')" required autofocus/>
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
