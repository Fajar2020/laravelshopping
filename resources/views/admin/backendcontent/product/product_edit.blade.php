	...
	<div class="controls">
		<select name="brand_id" class="form-control"  required="">
			@foreach($brands as $brand)
                <option value="{{ $brand->id }}" {{ $products->brand_id == $brand->id ? 'selected': ''}}>{{ $brand->brand_name_en }}</option>	
			@endforeach
		</select>
		@error('brand_id') 
	...
	<div class="controls">
		<select name="category_id" class="form-control"  required="">
			@foreach($categories as $category)
                <option value="{{ $category->id }}" {{ $products->category_id == $category->id ? 'selected': ''}}>{{ $category->category_name_en }}</option>	
			@endforeach
		</select>
		@error('category_id') 
	        <span class="text-danger">{{ $message }}</span>
	...
	<div class="controls">
		<select name="subcategory_id" class="form-control" required="" >
            @foreach($subcategories as $item2)
                <option value="{{$item2->id}}" {{ $products->subcategory_id == $item2->id ? 'selected': ''}}>{{$item2->subcategory_name_en}}</option>
            @endforeach
		</select>
...
<div class="form-group">
    ...
    <select name="subsubcategory_id" class="form-control" required="" >
        @foreach($subsubcategories as $item2)
            <option value="{{$item2->id}}" {{ $products->subsubcategory_id == $item2->id ? 'selected': ''}}>{{$item2->subsubcategory_name_en}}</option>
        @endforeach
