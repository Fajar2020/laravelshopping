...
<div class="form-group">
    ...
    <div class="controls">
        <input type="text" name="product_tags_ind" class="form-control" data-role="tagsinput" required="">
...
<div class="form-group">
    ...
    <div class="controls">
        <input type="text" name="product_size_ind" class="form-control" value="S,M,L" data-role="tagsinput" required="">
...
<div class="form-group">
	...
	<div class="controls">
        <input type="text" name="product_color_ind" class="form-control" value="Merah,Hitam,Putih" data-role="tagsinput" required="">
...
<div class="form-group">
    ...
    <div class="controls">
    <textarea id="editor2" name="long_descp_ind" rows="10" cols="80" required=""></textarea>       
	</div>
</div>
</div>
                            </div>
