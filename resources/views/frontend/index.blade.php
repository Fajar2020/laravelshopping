...
<div class="body-content outer-top-xs" id="top-banner-and-menu">
  <div class="container">
    <div class="row"> 
      <!-- SIDEBAR -->
      @include('frontend.sidebar_index') 
      
      <!--  CONTENT  -->
      <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder"> 
        <!-- SECTION – HERO  -->
        <!-- this is image slider usually we used it for the most important to grab people intention -->
        <div id="hero">
...
@endforeach
                    ...
                    <div class="products">
                      <div class="product">
                        ...
                        <div class="product-info text-left">
                          ...
                          @else
                            <div class="product-price"> <span class="price"> Rp.{{ $product->discount_price }} </span> <span class="price-before-discount">$ {{ $product->selling_price }}</span> </div>
                          @endif
                          <!-- /.product-price --> 
        ...
        <section class="section featured-product wow fadeInUp">
          <h3 class="section-title">
            @if(session()->get('language') == 'indonesia') {{ $skip_category->category_name_id }} @else {{ $skip_category->category_name_en }} @endif
          </h3>
          <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
        ...
        <section class="section featured-product wow fadeInUp">
          <h3 class="section-title">
            @if(session()->get('language') == 'indonesia') {{ $skip_brand->brand_name_id }} @else {{ $skip_brand->brand_name_en }} @endif
          </h3>
          <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
          @foreach($skip_brand_product as $product)
