...
<div class='col-sm-6 col-md-7 product-info-block'>
    <div class="product-info">
        <h1 class="name">
        @if(session()->get('language') == 'indonesia') {{ $product->product_name_ind }} @else {{ $product->product_name_en }} @endif </h1>
        ...
        @if(session()->get('language') == 'indonesia') {{ $product->short_descp_ind }} @else {{ $product->short_descp_en }} @endif
        ...
        <div class="quantity-container info-container">
			...
			{!! $product->long_descp_ind !!} @else {!! $product->long_descp_en !!} @endif</p>
									</div>	
								</div><!-- /.tab-pane -->
